# -*-eval: (setq-local org-footnote-section "Poznámky"); eval: (set-input-method "czech-qwerty"); eval: (set-register ?\' "“"); eval: (set-register ?\" "„"); eval: (set-register ?m "M.Ú.Ú.A.S.S.S.M.Z.Ú.S.M.O.V.S."); eval: (set-register ?T "");-*-
:Uvozovky:
# \bdquo = „
# \ldquo = “
# \sbquo = ‚
